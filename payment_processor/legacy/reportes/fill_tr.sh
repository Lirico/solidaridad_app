...
-e "truncate table repo_all_tr ;" 2>/dev/null
...
if(currcode_49='993', '1',if(currcode_49='994', '4',if(currcode_49='995', '5',
if(currcode_49='996', '2',if(currcode_49='997', '3', '0'))))) prod_id,
'CON.SALDO' trans, amount_4
from iso_pool where (datetime_trx between concat(DATE_FORMAT(DATE_SUB(CURRENT_DATE(), INTERVAL 1 MONTH) , '%Y-%m'), '-16')
...
and concat(DATE_FORMAT(DATE_SUB(CURRENT_DATE(), INTERVAL 0 MONTH) , '%Y-%m'), '-15') )
and mtype='0100' and respcode_39='00') t1)
;" 2>/dev/null
